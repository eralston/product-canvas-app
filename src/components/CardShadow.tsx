...
const CardShadow: React.FC<CardShadowProps> = ({
  id,
  content,
  initialX,
  initialY,
  ...
  return (
    <div
      ref={cardRef}
      className={`
        absolute bg-yellow-200 border border-yellow-300 rounded-lg cursor-move
      ...
      style={{
        ...
        zIndex: zIndex,
        // Shadow-focused interaction - dramatic shadow changes
        ...
        // Very subtle transform - let shadows do the heavy lifting
